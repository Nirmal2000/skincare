Help me integrate RevenueCat SDK into my BetterSkin app. I need to:

1. Configure it with my API key: test_xnPmvcdJaKdYprFRiltIpfJMotM

2. Set up basic subscription functionality in React Native

3. Set up entitlement checking for: BetterSkin Pro

4. Handle customer info and purchases

5. Configure products for my app:
...
- Entitlement checking for BetterSkin Pro
...
# Additional RevenueCat Documentation
...
- /dashboard-and-metrics/customer-profile - Individual customer purchase tracking
- /dashboard-and-metrics/customer-lists - Customer segmentation and analysis tools
- /dashboard-and-metrics/customer-profile#entitlements - Managing active subscriptions
- /dashboard-and-metrics/customer-profile#delete-customer - Customer account management
